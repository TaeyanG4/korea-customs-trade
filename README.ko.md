...
API pilot, 국가코드 검증, production collector, normalization pipeline, full historical backfill, 공식 연도별 HSK reference 수집, release QA, private-first Kaggle 검증, public Dataset 공개, public starter Notebook 공개, **Kaggle Usability 10.00 달성**까지 완료했습니다. 최초 핵심 가정은 다음이었습니다.
